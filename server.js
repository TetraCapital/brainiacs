...
const CSS = `<style>
:root {
  --black:#0e2016;--s1:#132618;--s2:#182e1e;--s3:#1e3825;
  --border:#2c5238;--bordm:#3a6848;
  ...
  --amber:#c49a28;
  --correct:#4a9e6e;--present:#c49a28;--absent:#101d13;--absentt:#3a6848;
...
.navbar{background:rgba(14,32,22,.97);backdrop-filter:blur(14px);border-bottom:1px solid var(--border);padding:0 28px;height:58px;display:flex;align-items:center;gap:28px;position:sticky;top:0;z-index:200}
...
(function() {
  ...
  function build(){
    ...
    hr.setAttribute('fill','none');hr.setAttribute('stroke','#182e1e');hr.setAttribute('stroke-width','1.5');
...
.tile.absent{background:var(--absent);border-color:#2c5238;color:#b0b0b0}
...
.key:hover{background:#234530}.key:active{transform:scale(.93)}
...
.key.ka{background:#101d13!important;border-color:#1a3020!important;color:var(--absentt)!important}
...
var PUZZLES=[
  {from:'alive',to:'bland',par:4},
  {from:'alive',to:'china',par:4},
  {from:'alive',to:'plant',par:4},
  {from:'alone',to:'brand',par:4},
  {from:'alone',to:'chase',par:4},
  {from:'alone',to:'china',par:4},
  {from:'along',to:'brand',par:4},
  {from:'along',to:'class',par:4},
  {from:'along',to:'crane',par:4},
  {from:'apart',to:'score',par:4},
  {from:'apart',to:'scout',par:4},
  {from:'apart',to:'shoot',par:4},
  {from:'arise',to:'peace',par:4},
  {from:'arise',to:'phone',par:4},
  {from:'arise',to:'plate',par:4},
  {from:'award',to:'scale',par:4},
  {from:'award',to:'score',par:4},
  {from:'award',to:'shade',par:4},
  {from:'aware',to:'scope',par:4},
  {from:'aware',to:'shall',par:4},
  {from:'aware',to:'shirt',par:4},
  {from:'baker',to:'bonus',par:4},
  {from:'baker',to:'fixed',par:4},
  {from:'baker',to:'level',par:4},
  {from:'beach',to:'broke',par:4},
  {from:'beach',to:'crush',par:4},
  {from:'beach',to:'grade',par:4},
  {from:'being',to:'drunk',par:4},
  {from:'being',to:'pride',par:4},
  {from:'being',to:'trick',par:4},
  {from:'bench',to:'brave',par:4},
  {from:'bench',to:'crash',par:4},
  {from:'bench',to:'grace',par:4},
  {from:'bible',to:'burst',par:4},
  {from:'bible',to:'nurse',par:4},
  {from:'bible',to:'purse',par:4},
  {from:'birth',to:'catch',par:4},
  {from:'birth',to:'fetch',par:4},
  {from:'birth',to:'force',par:4},
  {from:'black',to:'bring',par:4},
  {from:'black',to:'chunk',par:4},
  {from:'black',to:'cling',par:4},
  {from:'blade',to:'boost',par:4},
  {from:'blade',to:'chaos',par:4},
  {from:'blade',to:'coast',par:4},
  {from:'blame',to:'boost',par:4},
  {from:'blame',to:'chaos',par:4},
  {from:'blame',to:'coast',par:4},
  {from:'bland',to:'brook',par:4},
  {from:'bland',to:'chunk',par:4},
  {from:'blast',to:'break',par:4},
  {from:'blast',to:'clean',par:4},
  {from:'blast',to:'clear',par:4},
  {from:'blaze',to:'boost',par:4},
  {from:'blaze',to:'coast',par:4},
  {from:'blaze',to:'drive',par:4},
  {from:'bleed',to:'cream',par:4},
  {from:'bleed',to:'cruel',par:4},
  {from:'bleed',to:'dream',par:4},
  {from:'blend',to:'brain',par:4},
  {from:'about',to:'spare',par:5},
  {from:'blend',to:'crack',par:5},
  {from:'blend',to:'cruel',par:5},
  {from:'bless',to:'grant',par:5},
  {from:'bless',to:'photo',par:5},
  {from:'bless',to:'state',par:5},
  {from:'blind',to:'check',par:5},
  {from:'blind',to:'crack',par:5},
  {from:'blind',to:'creek',par:5},
  {from:'block',to:'cheer',par:5},
  {from:'block',to:'china',par:5},
  {from:'block',to:'crane',par:5},
  {from:'blood',to:'crack',par:5},
  {from:'blood',to:'cream',par:5},
  {from:'blood',to:'dream',par:5},
  {from:'blown',to:'chaos',par:5},
  {from:'blown',to:'great',par:5},
  {from:'blown',to:'press',par:5},
  {from:'bonus',to:'clone',par:5},
  {from:'bonus',to:'fixed',par:5},
  {from:'brain',to:'thick',par:5},
  {from:'brain',to:'think',par:5},
  {from:'brand',to:'click',par:5},
  {from:'brave',to:'thick',par:5},
  {from:'bread',to:'clock',par:5},
  {from:'bread',to:'floor',par:5},
  {from:'bread',to:'gloom',par:5},
  {from:'break',to:'clone',par:5},
  {from:'break',to:'flood',par:5},
  {from:'breed',to:'class',par:5},
  {from:'breed',to:'glass',par:5},
  {from:'brief',to:'class',par:5},
  {from:'brief',to:'glass',par:5},
  {from:'bring',to:'check',par:5},
  {from:'bring',to:'clock',par:5},
  {from:'broad',to:'sleep',par:5},
  {from:'broke',to:'reach',par:5},
  {from:'broke',to:'teach',par:5},
  {from:'brook',to:'place',par:5},
  {from:'brown',to:'glass',par:5},
  {from:'build',to:'grade',par:5},
  {from:'built',to:'grade',par:5},
  {from:'bunch',to:'lease',par:5},
  {from:'bunch',to:'least',par:5},
  {from:'burst',to:'cover',par:5},
  {from:'burst',to:'peace',par:5},
  {from:'candy',to:'herbs',par:5},
  {from:'catch',to:'lease',par:5},
  {from:'catch',to:'least',par:5},
  {from:'cause',to:'moral',par:5},
  {from:'chair',to:'score',par:5},
  {from:'chair',to:'sword',par:5},
  {from:'chalk',to:'storm',par:5},
  {from:'chalk',to:'story',par:5},
  {from:'chalk',to:'sword',par:5},
  {from:'charm',to:'dense',par:5},
  {from:'charm',to:'drone',par:5},
  {from:'charm',to:'prose',par:5},
  {from:'chase',to:'sport',par:5},
  {from:'chase',to:'stern',par:5},
  {from:'cheap',to:'tried',par:5},
  {from:'check',to:'gross',par:5},
  {from:'cheer',to:'pluck',par:5},
  {from:'cheer',to:'skill',par:5},
  {from:'chest',to:'price',par:5},
  {from:'chest',to:'pride',par:5},
  {from:'chest',to:'prize',par:5},
  {from:'chief',to:'skull',par:5},
  {from:'chief',to:'spell',par:5},
  {from:'child',to:'slave',par:5},
  {from:'child',to:'steal',par:5},
  {from:'child',to:'stone',par:5},
  {from:'chunk',to:'flash',par:5},
  {from:'clash',to:'shock',par:5},
  {from:'clash',to:'stick',par:5},
  {from:'clash',to:'stock',par:5},
  {from:'clerk',to:'tried',par:5},
  {from:'click',to:'drone',par:5},
  {from:'click',to:'gross',par:5},
  {from:'cliff',to:'grant',par:5},
  {from:'cliff',to:'wheat',par:5},
  {from:'climb',to:'drone',par:5},
  {from:'climb',to:'prose',par:5},
  {from:'climb',to:'sauce',par:5},
  {from:'cling',to:'feast',par:5},
  {from:'cling',to:'grove',par:5},
  {from:'clock',to:'dream',par:5},
  {from:'clone',to:'press',par:5},
  {from:'close',to:'shark',par:5},
  {from:'close',to:'sharp',par:5}
];
...
.kba{background:#c0392b!important;border-color:#c0392b!important;color:#fff!important}
/* Toast */
.toast{position:fixed;top:80px;left:50%;transform:translateX(-50%);background:#ffffff;color:#141414;font-family:var(--fm);font-size:13px;letter-spacing:.06em;padding:10px 22px;border-radius:var(--r);pointer-events:none;opacity:0;transition:opacity .2s;z-index:999;white-space:nowrap}
.toast.show{opacity:1}
/* Shake */
...
function colorBLAbsentKeys(guess){if(!window.matchMedia('(hover:hover) and (pointer:fine)').matches)return;for(var i=0;i<guess.length;i++){var l=guess[i].toLowerCase();var btn=document.querySelector('.key[data-k="'+l+'"]');if(btn&&btn.dataset.state!=='correct'&&btn.dataset.state!=='present'){btn.classList.remove('kc','kp','ka','kba');btn.classList.add('kba');btn.dataset.state='absent-confirmed';}}}
