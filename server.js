...
.btn-secondary{background:transparent;border:1px solid var(--border);color:var(--fg2);font-family:var(--fm);font-size:12px;font-weight:500;letter-spacing:.09em;text-transform:uppercase;padding:10px 22px;border-radius:var(--r);cursor:pointer;transition:border-color .15s,color .15s}
